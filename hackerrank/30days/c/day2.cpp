...
void solve(double meal_cost, int tip_percent, int tax_percent) {
    ...
    double tip = (tip_percent*meal_cost/100); // my mistake was using int for tip and tax, using duoble fixed my sample cases
    double tax = (tax_percent*meal_cost/100);
    int totalc = round(meal_cost +tax+tip);
    cout<< totalc;
...
// i left their getline methods since i learned a little something new
